...
export function canSurf(): boolean {
  return (
    Items.has("HM 03 Surf") &&
    (Items.has("Soul Badge") || Settings.BadgeHMRequirement === BadgeHMRequirement.None)
  );
}
...
export function canCut(): boolean {
  return (
    Items.has("HM 01 Cut") &&
    (Items.has("Cascade Badge") || Settings.BadgeHMRequirement === BadgeHMRequirement.None)
  );
}

export function canFly(): boolean {
  return (
    (Items.has("HM 02 Fly") || Items.has("Flute")) &&
    (Items.has("Thunder Badge") || Settings.BadgeHMRequirement === BadgeHMRequirement.None)
  );
}

export function canStrength(): boolean {
  return (
    (Items.has("HM 04 Strength") || Items.has("Titan's Mitt")) &&
    (Items.has("Rainbow Badge") || Settings.BadgeHMRequirement === BadgeHMRequirement.None)
  );
}

export function canFlash(): boolean {
  return (
    (Items.has("HM 05 Flash") || Items.has("Lamp")) &&
    (Items.has("Boulder Badge") || Settings.BadgeHMRequirement === BadgeHMRequirement.None)
  );
}
...
export function canPassGuards(): boolean {
  return (
    (Settings.Tea && Items.has("Tea")) || (!Settings.Tea && Items.has("Vending Machine Drinks"))
  );
}
...
export function enoughFossils(count: number): boolean {
  return (
    countCheck(["Dome Fossil", "Helix Fossil", "Old Amber"], count) &&
...
export function canRoute3(): boolean {
  return (
    (Items.has("Defeat Brock") && Settings.Route3Req === Route3Req.DefeatBrock) ||
    ...
    (countCheck(
      ...
      Settings.Route3Req === Route3Req.DefeatAny) ||
...
export function evolveLevel(level: number): boolean {
  ...
  return (
    [
      ...
      "Defeat Sabrina",
      "Defeat Viridian Gym Giovanni",
    ].filter((gym) => Items.has(gym)).length >
    level / 7
  );
}
...
export function canEnterCeruleanCave(): boolean {
  ...
  return (
    enoughBadges(Settings.CeruleanCaveBadges) &&
    enoughKeyItems(Settings.CeruleanCaveKeyItems) &&
    canSurf()
  );
}
...
export function canEnterEliteFour(): boolean {
  ...
  return (
    enoughBadges(Settings.EliteFourBadges) &&
